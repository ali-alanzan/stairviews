...
*/
    ...
    ;
    var Ia = function(a) {
        if (a instanceof v && a.constructor === v && a.ja === Ga)
            return a.U;
    ...
    ;
    var Ka = function(a) {
        if (a instanceof x && a.constructor === x)
            return a.S;
    ...
    ;
    var Qa = new Pa("OFF",Infinity), Ra = new Pa("WARNING",900), Sa = new Pa("CONFIG",700), Ta = function() {
        this.C = 0;
        this.clear()
    }, Ua;
...
*/
    ...
    var hb = function(a, b) {
        Da(b, function(c, d) {
            ...
            "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : fb.hasOwnProperty(d) ? a.setAttribute(fb[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c
        })
    }
      , fb = {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var y = window
      ...
      , vb = /'/g
      , wb = function(a) {
        return String(a).replace(rb, "&amp;").replace(sb, "&lt;").replace(tb, "&gt;").replace(ub, "&quot;").replace(vb, "&#39;")
    }
      , C = function() {
        var a;
        if ((a = Object.create) && ob.test(a))
            a = a(null);
        else {
            a = {};
            for (var b in a)
    ...
    var I = function(a, b, c) {
      ...
      , zb = new RegExp(/^/.source + /([a-zA-Z][-+.a-zA-Z0-9]*:)?/.source + /(\/\/[^\/?#]*)?/.source + /([^?#]*)?/.source + /(\?([^#]*))?/.source + /(#((#|[^#])*))?/.source + /$/.source)
      , Ab = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g
      , Bb = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,"g")
      ...
      , Ib = new RegExp(/\/?\??#?/.source + "(" + /[\/?#]/i.source + "|" + /[\uD800-\uDBFF]/i.source + "|" + /%[c-f][0-9a-f](%[89ab][0-9a-f]){0,2}(%[89ab]?)?/i.source + "|" + /%[0-9a-f]?/i.source + ")$","i")
      , Jb = function(a, b) {
        var c = Eb(b);
        b = c.B;
        ...
        a instanceof Oa && a.constructor === Oa ? a = a.R : (za("expected object of type SafeHtml, got '" + a + "' of type " + ia(a)),
    ...
    var Mb = function(a, b, c, d) {
        if (y[c + "EventListener"])
            y[c + "EventListener"](a, b, !1);
        else if (y[d + "tachEvent"])
            y[d + "tachEvent"]("on" + a, b)
    }
      , Nb = function() {
        var a = A.readyState;
      ...
      , Pb = function(a) {
        if (Nb())
            ...
            y.addEventListener ? (y.addEventListener("load", c, !1),
            y.addEventListener("DOMContentLoaded", c, !1)) : y.attachEvent && (y.attachEvent("onreadystatechange", function() {
    ...
    var ec = /^(\/[a-zA-Z0-9_\-]+)+$/
        ...
        try {
            ...
            if (e && 0 < e.length) {
                ...
                for (d = {}; c < e.length; ) {
                    var l = e[c++];
                    f = void 0;
                    f = u(l) ? "o" + (Object.prototype.hasOwnProperty.call(l, ma) && l[ma] || (l[ma] = ++na)) : (typeof l).charAt(0) + l;
      ...
      , pc = function(a, b, c, d) {
        ...
        return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.W ? "/am=" + e(a.W) : "", a.fa ? "/rs=" + e(a.fa) : "", a.ha ? "/t=" + e(a.ha) : "", "/cb=", e(c)].join("")
    }
      , nc = function(a) {
        ...
        c = 0;
        for (d = fc.length; c < d; ++c)
            fc[c].test(b) && P("invalid_prefix");
        c = qc(a, "k", !0);
        d = qc(a, "am");
        e = qc(a, "rs");
        a = qc(a, "t");
    ...
    var rc = decodeURI("%73cript")
      ...
      , uc = function() {
        var a = M.nonce;
        return void 0 !== a ? a && a === String(a) && a.match(sc) ? a : M.nonce = null : A.querySelector ? (a = A.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "",
        a && a === String(a) && a.match(sc) ? M.nonce = a : M.nonce = null) : null : null
    }
      , xc = function(a) {
      ...
      , vc = function(a) {
        ...
        b.async = "true";
        (a = A.getElementsByTagName(rc)[0]) ? a.parentNode.insertBefore(b, a) : (A.head || A.body || A.documentElement).appendChild(b)
    }
      , zc = function(a, b, c) {
        yc(function() {
    ...
    var Dc = function(a) {
      ...
      , Q = function(a, b, c) {
        if (b && "object" === typeof b)
            for (var d in b)
                !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Fc(a[d]) && !Fc(b[d]) ? Q(a[d], b[d]) : b[d] && "object" === typeof b[d] ? (a[d] = Fc(b[d]) ? [] : {},
                Q(a[d], b[d])) : a[d] = b[d])
    }
      , Gc = function(a) {
        if (a && !/^\s+$/.test(a)) {
      ...
      , Ic = function(a) {
        ...
        for (var g = 0; g < e.length; ++g)
            for (var k = e[g], h = 0; h < f.length; ++h)
                k.src && 0 == k.src.indexOf(f[h]) && d.push(k);
    ...
    var $c, V, W = void 0, X = function(a) {
    ...
    }, ad = Y(0), bd = Y(new Date(0)), cd = Y(!0), dd = Y(""), ed = Y({}), fd = Y([]), gd = function(a, b) {
        if (b)
        ...
        if ("undefined" !== d) {
            ...
            b = [];
            var e = Y(a);
            if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a, "toJSON") || (e !== fd || a.constructor !== Array && a.constructor !== Object) && (e !== ed || a.constructor !== Array && a.constructor !== Object) && e !== dd && e !== ad && e !== cd && e !== bd))
            ...
            if (null == a)
                ...
                if (e === bd)
                    return gd(a.toISOString.call(a), c);
                if (e === fd && Y(a.length) === ad) {
                    b[b.length] = "[";
                    var f = 0;
                    for (d = Number(a.length) >> 0; f < d; ++f)
                        f && (b[b.length] = ","),
                        b[b.length] = gd(a[f], c) || "null";
                    b[b.length] = "]"
                    ...
                    d = 0;
                    for (f in a)
                        Object.prototype.hasOwnProperty.call(a, f) && (e = gd(a[f], c),
    ...
    }, hd = /[\0-\x07\x0b\x0e-\x1f]/, id = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/, jd = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/, kd = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/, ld = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g, md = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g, nd = /[ \t\n\r]+/g, od = /[^"]:/, pd = /""/g, qd = /true|false|null/g, rd = /00/, sd = /[\{]([^0\}]|0[^:])/, td = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/, ud = /[^\[,:][\[\{]/, vd = /^(\{|\}|\[|\]|,|:|0)+/, wd = /\u2028/g, xd = /\u2029/g, yd = function(a) {
        a = String(a);
        if (hd.test(a) || id.test(a) || jd.test(a) || kd.test(a))
            return !1;
        var b = a.replace(ld, '""');
        b = b.replace(md, "0");
        b = b.replace(nd, "");
        ...
        b = b.replace(pd, "0");
        b = b.replace(qd, "0");
        if (rd.test(b) || sd.test(b) || td.test(b) || ud.test(b) || !b || (b = b.replace(vd, "")))
            return !1;
        ...
        if (-1 !== V)
            return zd(),
            W ? t.JSON.stringify.call(t.JSON, a) : gd(a)
    }, Cd = !Date.prototype.toISOString || "function" !== typeof Date.prototype.toISOString || "1970-01-01T00:00:00.000Z" !== (new Date(0)).toISOString(), Dd = function() {
    ...
    Jd || (Nd = 1E6 * (screen.width * screen.width + screen.height),
    ...
    var Rd = function() {
      ...
      , Sd = function(a, b) {
        b = b.onload;
        return "function" === typeof b ? (Rd().a(a, b),
        b) : null
    }
      , Td = function(a) {
    ...
    var Vd = {
      ...
      , Zd = function(a, b, c, d, e) {
        Yd(c.src);
        var f, g = Sd(d, c), k = g ? Td(d) : "";
        try {
            document.all && (f = a.createElement('<iframe frameborder="' + wb(String(c.frameborder)) + '" scrolling="' + wb(String(c.scrolling)) + '" ' + k + ' name="' + wb(String(c.name)) + '"/>'))
        } catch (l) {} finally {
            f || (f = (a ? new lb(kb(a)) : va || (va = new lb)).ma("IFRAME"),
            g && (f.onload = function() {
                f.onload = null;
                g.call(this)
            }
        ...
        for (var h in c)
            a = c[h],
            "style" === h && "object" === typeof a ? E(a, f.style) : Wd[h] || f.setAttribute(h, String(a));
    ...
    var ee = function(a) {
      ...
      , fe = function(a) {
        ...
        for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
            ...
            if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = ee(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i))
                return e
        }
    ...
    var ge = {
      ...
      , le = function(a, b, c) {
        ...
        c = {};
        for (var l in f)
            D(f, l) && h.test(l) && (c[l.replace(h, "")] = f[l],
            delete f[l]);
        l = "q" == S("iframes/" + a + "/params/si") ? f : c;
        h = Oc();
        for (var n in h)
            !D(h, n) || D(f, n) || D(c, n) || (l[n] = h[n]);
        n = [].concat(je);
        (l = S("iframes/" + a + "/methods")) && "object" === typeof l && ob.test(l.push) && (n = n.concat(l));
        for (var q in b)
            D(b, q) && /^on/.test(q) && ("plus" != a || "onconnect" != q) && (n.push(q),
            delete f[q]);
        delete f.callback;
        c._methods = n.join(",");
        return Hb(e, f, c)
      ...
      , oe = function(a) {
        for (var b = C(), c = 0 != a.nodeName.toLowerCase().indexOf("g:"), d = a.attributes.length, e = 0; e < d; e++) {
            var f = a.attributes[e]
              , g = f.name
              , k = f.value;
            0 <= pb.call(me, g) || c && 0 != g.indexOf("data-") || "null" === k || "specified"in f && !f.specified || (c && (g = g.substr(5)),
            b[g.toLowerCase()] = k)
        }
        a = a.style;
    ...
    var se, te, ue, ve, we, xe = /(?:^|\s)g-((\S)*)(?:$|\s)/, ye = {
        plusone: !0,
        autocomplete: !0,
        profile: !0,
        signin: !0,
      ...
      , Ae = function(a, b, c, d) {
        ...
        for (f = 0; f < e.length; f++) {
            ...
            var h = g.nodeName.toLowerCase()
              , l = void 0;
            if (g.getAttribute("data-gapiscan"))
                k = null;
            else {
                var n = h.indexOf("g:");
            ...
            k && (ye[k] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != xb(oe(g)).length) && (g.setAttribute("data-gapiscan", !0),
            B(c, k, []).push(g))
        }
        if (b)
            for (var q in c)
        ...
        if (Ce(we || {}))
            for (var J in c) {
                a = c[J];
                p = 0;
                for (b = a.length; p < b; p++)
                    a[p].removeAttribute("data-gapiscan");
                De(J)
            }
        else {
            d = [];
    ...
    var De = function(a, b) {
        var c = Vb(a);
        b && c ? (c(b),
        (c = b.iframeNode) && c.setAttribute("data-gapiattached", !0)) : H.load(a, function() {
            var d = Vb(a)
              , e = b && b.iframeNode
              , f = b && b.userParams;
            e && d ? (d(b),
            e.setAttribute("data-gapiattached", !0)) : (d = H[a].go,
      ...
      , Ee = function(a, b, c, d, e, f) {
        ...
        case 1:
            if (b.parentNode) {
                ...
                g = b = k;
                $d.test(b) && (g = U("iframes/" + g.substring(1) + "/url"),
                F(!!g, "Unknown iframe url config for - " + b));
                k = Jb(A, g.replace(ae, ce));
                b = c.ownerDocument || A;
                h = 0;
                do
                    g = f.id || ["I", Xd++, "_", (new Date).getTime()].join("");
                ...
                n = n || "";
                !n && p && (p = I(b.location.href, "_gfid", "") || I(b.location.href, "id", ""),
                n = I(b.location.href, "pfname", ""),
                n = p ? n + "/" + p : "");
                n || (p = Ad(I(b.location.href, "jcp", ""))) && "object" == typeof p && (n = (n = p.id) ? p.pfname + "/" + n : "");
                q.pfname = n;
                f.connectWithJsonParam && (p = {},
                p.jcp = Bd(q),
                q = p);
      ...
      , qe = function(a, b) {
        ...
        if (d) {
            ...
            Rc.log("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
    };
    B(H, "platform", {}).go = Be;
    Ce = function(a) {
        ...
        function d(f) {
            ...
            if (Re(g, b)) {
                ...
                Se(a, function() {
                    h && N("rqd");
                    c();
                    for (var l = B(M, "RPMQ", []), n = 0; n < l.length; n++)
                        l[n]({
                            data: g,
                            origin: k
                        })
    ...
    var Xe = "https:" === window.location.protocol
      ...
      , $e = function() {
        ...
        Ye.iterate(function(c, d) {
            0 === c.indexOf("G_AUTHUSER_") && (c = Ze(c.substring(11)),
            !a || c.l && !a.l || c.l == a.l && c.o > a.o) && (a = c,
            b = d)
        });
        return {
            la: a,
    ...
    ;
    m.ea = function() {
        this.O && (this.Y() ? this.A = this.V : this.A = Math.min(2 * (this.A || this.V), 120),
